        ...
        <div class="breadcrumbs-custom-inner">
          <div class="container breadcrumbs-custom-container">
            <div class="breadcrumbs-custom-main">
              ...
              <h2 class="text-uppercase breadcrumbs-custom-title">Ласкаво просимо до вікна авторизації</h2>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9 cell-inner">
                        <div class="section-lg">
                            <h3 class="text-uppercase wow-outer"><span class="wow slideInDown">Авторизація</span></h3>
                            <!-- RD Mailform-->
                            ㅤ
                            ㅤ
                            ㅤ
                            ...
                            <form action="../bat/autoriz.php" method="POST">
                              <div class="row row-10">
                                  <div class="col-md-6 wow-outer">
                                      <div class="form-wrap wow fadeSlideInUp">
                                          <label class="form-label-outside" for="contact-login">Логін</label>
                                          <input class="form-input" id="username" type="username" name="username" data-constraints="@Required">
                                      </div>
                                  </div>
                                  <div class="col-md-6 wow-outer">
                                      <div class="form-wrap wow fadeSlideInUp">
                              ...
                              <div class="group group-middle">
                                  ...
                                  <p>або</p>
                                  <div class="wow-outer">
                                      <a class="button button-primary-outline button-icon button-icon-left button-winona wow slideInLeft" href="registr.php">
