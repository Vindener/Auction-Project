...
<body>
  ...
  <div>
    <h1 class="title">Перегляд аукціону</h1>
      <hr>
      <form class="form-auto" action="../index.php" method="post">
        <p>№ аукіону</p>
        <input type="text" name="IDAuction" value="<?= $row['IDAuction'] ?>" disabled>
        <?php 
        ...
        <input type="text" name="Brand" value="<?= $row['Brand']?> <?= $row['Model']?>" disabled>
        <p>Ім'я користувача та його індекс</p>
        <input type="text" name="CFamilia" value="<?= $row['CFamilia'] ?> <?= $row['AuctionIDClient'] ?>" disabled>
        <p>Початок аукціону</p>
        <input type="text" name="StartAuction" value="<?= $row['StartAuction'] ?>" disabled>
        <p>Кінець аукціону</p>
        <input type="text" name="EndAuction" value="<?= $row['EndAuction'] ?>" disabled>
        <p>Мінімальна ціна</p>
        <input type="text" name="MinPrice" value="<?= $row['MinPrice'] ?>" disabled>
        <p>Індекс переможця</p>
        <input type="text" name="IDWinner" value="<?= $row['IDWinner'] ?>" disabled>
        <p>Стан</p>
        <input type="text" name="State" value="<?= $row['State'] ?>" disabled>
        <br><br>
