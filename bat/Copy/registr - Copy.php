            ...
            <div class="rd-navbar-aside-outer">
              <div class="rd-navbar-aside">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand--><a class="rd-navbar-brand" href="index.html"><img src="images/Mlogo-lingh-151x44.png" alt="" width="151" height="44" srcset="images/Mlogo-lingh-151x44.png 2x"/></a>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9 cell-inner">
                        <div class="section-lg">
                            ...
                            <!-- RD Mailform-->
                            <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="fetch_auctions.php">
                                <div class="row row-10">
                                    <div class="col-md-6 wow-outer">
                                        <div class="form-wrap wow fadeSlideInUp">
                                            <label class="form-label-outside" for="contact-first-name">Логін</label>
                                            <input class="form-input" id="contact-first-name" type="text" name="name" data-constraints="@Required">
                                        </div>
                                    </div>
                                    <div class="col-md-6 wow-outer">
                                        <div class="form-wrap wow fadeSlideInUp">
                                            <label class="form-label-outside" for="contact-last-name">Пароль</label>
                                    ...
                                    <div class="col-md-6 wow-outer">
                                      <div class="form-wrap wow fadeSlideInUp">
                                          <label class="form-label-outside" for="contact-last-name">Ім'я</label>
                                          <input class="form-input" id="contact-last-name" type="text" name="name" data-constraints="@Required">
                                      </div>
                                  </div>
                                  <div class="col-md-6 wow-outer">
                                ...
                                <div class="col-md-6 wow-outer">
                                  <div class="form-wrap wow fadeSlideInUp">
                                      <label class="form-label-outside" for="contact-last-name">По батькові</label>
                                       <input class="form-input" id="contact-last-name" type="text" name="name" data-constraints="@Required">
                                  </div>
                              </div>
                                </div>
                                <div class="group group-middle">
                                    <p>або</p>
                                    <div class="wow-outer">
                                      <button class="button button-primary-outline button-icon button-icon-left button-winona wow slideInLeft" href="#" onclick="">
                                        <span class=""></span>Зареєструватись
                                      </button>
                                  </div>
                                </div>
                            </form>
                            <!-- Сюди будуть вставлені дані з PHP -->
                            <div id="client-list">
                        </div>     
                            <script>
    $(document).ready(function(){
        $.ajax({
            url: 'fetch_auctions.php', // URL вашого PHP файлу
            type: 'GET',
            success: function(data) {
                $('#client-list').html(data); // Вставити отримані дані в елемент з id="client-list"
            },
            error: function(xhr, status, error) {
                console.error(xhr.responseText); // Вивести повідомлення про помилку в консоль
            }
        });
    });
    </script>
