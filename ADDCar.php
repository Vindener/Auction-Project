                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9 cell-inner">
                        <div class="section-lg">
                            <h3 class="text-uppercase wow-outer"><span class="wow slideInDown">Додати нову машину</span></h3>
                            <!-- RD Mailform-->                           
     <form action="../bat/carReg.php" method="POST" enctype="multipart/form-data">
